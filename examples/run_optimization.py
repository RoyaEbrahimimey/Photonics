...
polarization="TE"
angle_incidence=0
n_layers = np.array([1.45, 2.1, 1.45, 2.0,1.45, 2.1, 1.45, 2.0])
initial_d = np.array([100e-9, 70e-9, 100e-9, 100e-9,100e-9, 70e-9, 100e-9, 100e-9])
bounds = [
    (50e-9, 300e-9),
    (50e-9, 300e-9),
    (50e-9, 300e-9),
...
def objective_function(d_layers, n_layers, wavelengths, n_in, n_substrate, angle_incidence, polarization):
    ...
    return np.mean((T_spectrum - target_T)**2) # Minimize reflection at the target wavelength
